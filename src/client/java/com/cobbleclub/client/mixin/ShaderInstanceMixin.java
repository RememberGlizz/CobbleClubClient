...
public abstract class ShaderInstanceMixin {
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/class_2960;method_60656(Ljava/lang/String;)Lnet/minecraft/class_2960;",
                    remap = false
            ),
            allow = 1,
            remap = false
    )
    private Identifier cobbleclub$modifyId(
            String id,
            Operation<Identifier> original
    ) {
        if ((Object) this instanceof IrisIgnoreShader) {
            return FabricShaderProgram.rewriteAsId(
                    id,
                    this.field_29494
            );
        }
