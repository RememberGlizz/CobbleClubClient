...
public final class RevealedBattleInfo {
    ...
    public final Map<String, RevealedMove> moves = new LinkedHashMap<String, RevealedMove>();
    ...
    public void recordMoveUse(String moveId, String displayName, String typeId) {
        if (moveId != null && !moveId.isBlank()) {
            RevealedMove move = this.moves.computeIfAbsent(moveId, id -> new RevealedMove(displayName, typeId));
            ++move.uses;
        }
    }
