...
public final class ClaimListPanel {
   ...
   public ClaimListPanel(ClaimsState state, class_327 font, Consumer<String> onSelect, BooleanSupplier trusted) {
      this.state = state;
      this.font = font;
   ...
   public void render(class_332 g, int mouseX, int mouseY, String selectedClaimId) {
      g.method_25294(this.x0, this.y0, this.x1, this.y1, -15723477);
      ...
      this.scroll = class_3532.method_15340(this.scroll, 0, this.maxScroll(rows));
      String header = (trustedTab ? "Trusted Claims (" : "Your Claims (") + this.claims().size() + ")";
      g.method_27535(this.font, class_2561.method_43470(header).method_27692(class_124.field_1080), this.x0 + 8, this.y0 + 5, -7035976);
      g.method_25294(this.x0 + 1, this.listTop() - 1, this.x1 - 1, this.listTop(), -13747610);
      if (rows.isEmpty()) {
         g.method_27534(this.font, class_2561.method_43470(trustedTab ? "No trusted claims" : "No claims yet"), (this.x0 + this.x1) / 2, (this.y0 + this.y1) / 2 - 10, -7035976);
         g.method_27534(this.font, class_2561.method_43470(trustedTab ? "Claims others trust you in appear here" : "Claim land on the Map tab").method_27692(class_124.field_1080), (this.x0 + this.x1) / 2, (this.y0 + this.y1) / 2 + 2, -7035976);
      } else {
         g.method_44379(this.x0 + 1, this.listTop(), this.x1 - 1, this.y1 - 1);
         ...
         for(Row row : rows) {
            if (y + row.height() >= this.listTop() && y <= this.y1) {
               ...
               if (row.sub() == null) {
                  ...
                  g.method_44379(this.x0 + 4, y, this.x1 - 8, y + row.height());
                  class_327 var10001 = this.font;
                  String var10002 = row.sub().getName();
                  g.method_27535(var10001, class_2561.method_43470("└ " + var10002).method_27692(class_124.field_1080), this.x0 + 18, y + 4, hover ? -1 : -7035976);
                  g.method_44380();
               }
            }
         ...
         if (!trustedTab && this.maxScroll(rows) == 0 && y + 26 < this.y1) {
            g.method_27534(this.font, class_2561.method_43470("Shift+drag on the Map tab to claim more land").method_27692(class_124.field_1080), (this.x0 + this.x1) / 2, y + 12, -7035976);
         }
   ...
   private void renderClaimRow(class_332 g, Row row, int y, boolean hover, boolean selected) {
      ClaimDetailEntry claim = row.claim();
      g.method_25294(this.x0 + 2, y, this.x1 - 7, y + 30 - 2, hover ? -14405546 : -15064506);
      g.method_25294(this.x0 + 2, y, this.x0 + 5, y + 30 - 2, claim.isOwner() ? -6467875 : -2054081);
      if (selected) {
         g.method_49601(this.x0 + 2, y, this.x1 - this.x0 - 9, 28, -6467875);
      }
      ...
      int statsX = this.x1 - 12 - Math.max(this.font.method_1727(stats), this.font.method_1727(statsMeta));
      g.method_44379(this.x0 + 6, y, statsX - 4, y + 30);
      g.method_27535(this.font, class_2561.method_43470(claim.getName()), this.x0 + 10, y + 5, -1);
      if (row.standing()) {
         g.method_27535(this.font, class_2561.method_43470("Standing in this one").method_27692(class_124.field_1060), this.x0 + 10 + this.font.method_1727(claim.getName()) + 8, y + 5, -11141291);
      }

      String zone = claim.getZone() != null ? claim.getZone() : claim.getDimension();
      String meta = claim.isOwner() ? zone : zone + " · " + claim.getOwnerName();
      g.method_27535(this.font, class_2561.method_43470(meta).method_27692(class_124.field_1080), this.x0 + 10, y + 17, -7035976);
      g.method_44380();
      g.method_25303(this.font, stats, this.x1 - 12 - this.font.method_1727(stats), y + 5, -2053377);
      g.method_25303(this.font, statsMeta, this.x1 - 12 - this.font.method_1727(statsMeta), y + 17, -7035976);
   }
   ...
   public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
      if (!this.contains(mouseX, mouseY)) {
         ...
         this.scroll = class_3532.method_15340(this.scroll - (int)(scrollY * (double)30.0F), 0, this.maxScroll(this.rows()));
         return true;
      }
   }
